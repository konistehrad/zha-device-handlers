...
class EnoceanPTM215ZEDevice(CustomGreenPowerDevice, priority=5):
    @classmethod
    ...
    device_automation_triggers = {
        ...
        (PRESSED, BUTTON_1_AND_2): {
            COMMAND: COMMAND_NOTIFICATION,
            CLUSTER_ID: GREENPOWER_CLUSTER_ID,
            PARAMS: {COMMAND_ID: 0x64}
        },
        (RELEASED, BUTTON_1_AND_2): {
            COMMAND: COMMAND_NOTIFICATION,
            CLUSTER_ID: GREENPOWER_CLUSTER_ID,
        ...
        (PRESSED, BUTTON_1_AND_4): {
            COMMAND: COMMAND_NOTIFICATION,
            CLUSTER_ID: GREENPOWER_CLUSTER_ID,
            PARAMS: {COMMAND_ID: 0x1e}
        },
        (RELEASED, BUTTON_1_AND_4): {
            COMMAND: COMMAND_NOTIFICATION,
            CLUSTER_ID: GREENPOWER_CLUSTER_ID,
            PARAMS: {COMMAND_ID: 0x1f}
        },

        (PRESSED, BUTTON_2_AND_3): {
            COMMAND: COMMAND_NOTIFICATION,
            CLUSTER_ID: GREENPOWER_CLUSTER_ID,
            PARAMS: {COMMAND_ID: 0x1c}
        },
        (RELEASED, BUTTON_2_AND_3): {
            COMMAND: COMMAND_NOTIFICATION,
            CLUSTER_ID: GREENPOWER_CLUSTER_ID,
        ...
        (PRESSED, BUTTON_3_AND_4): {
            COMMAND: COMMAND_NOTIFICATION,
            CLUSTER_ID: GREENPOWER_CLUSTER_ID,
            PARAMS: {COMMAND_ID: 0x16}
        },
        (RELEASED, BUTTON_3_AND_4): {
            COMMAND: COMMAND_NOTIFICATION,
            CLUSTER_ID: GREENPOWER_CLUSTER_ID,
